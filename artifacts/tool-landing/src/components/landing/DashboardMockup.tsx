...
import { ArrowRight, Check, ChevronLeft, ChevronRight, Compass, Maximize2, MonitorCog, RefreshCw, Users, X } from "lucide-react";
...
const nodes = [
  ...
  },
  {
    number: "02",
    label: "Cambio",
    detail: "Rediseñamos cómo opera la empresa",
  ...
  {
    number: "03",
    label: "Cultura y adopción",
    detail: "Hacemos que el cambio ocurra de verdad",
    description: "Trabajamos con liderazgo, aprendizaje y participación hasta que la nueva forma de operar se entiende, se usa y se vuelve hábito.",
    result: "Capacidad instalada y cambio que permanece después del proyecto.",
    deliverables: ["Hábitos y liderazgo", "Aprendizaje aplicado", "Participación y ludificación"],
    icon: Users,
  },
  {
    number: "04",
    label: "Tecnología",
    detail: "Escalamos lo que funciona",
...
export default function DashboardMockup() {
  ...
  return (
    <Dialog.Root open={activeNode !== null} onOpenChange={(open) => !open && setActiveNode(null)}>
      <div className="hero-map" aria-label="Estrategia, cambio, cultura y tecnología conectadas al valor de TOOL">
        ...
        <div className="hero-map-center">
          <span>VALOR TOOL</span><strong>Una forma de trabajar sostenible</strong><small>Elegir · cambiar · adoptar · escalar</small>
        </div>
